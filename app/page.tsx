    ...
    <main style={{ "--scroll-progress": progress } as CSSProperties}>
      ...
      <section className="hero hero-immersive" id="inicio">
        ...
        <div className="transformer-stage" aria-hidden="true">
          <img className="transformer transformer-left" style={{ transform: `translate3d(${(sceneProgress - 1) * 45}vw, ${sceneProgress * 48}px, 0) rotate(${-7 + sceneProgress * 5}deg)` }} src="/assets/transformer-left.png" alt="" />
          <img className="transformer transformer-right" style={{ transform: `translate3d(${(1 - sceneProgress) * 45}vw, ${sceneProgress * 40}px, 0) rotate(${7 - sceneProgress * 5}deg)` }} src="/assets/transformer-right.png" alt="" />
