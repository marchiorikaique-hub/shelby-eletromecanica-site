    ...
    <main style={{ "--scroll-progress": progress } as CSSProperties}>
      ...
      <section className="hero hero-immersive" id="inicio">
        ...
        <div className="hero-copy immersive-copy">
          ...
          <div className="hero-actions"><a className="btn-primary" href="#servicos">Explorar soluções <span>↗</span></a><a className="btn-link" href="#diagnostico"><i>↓</i> Solicitar avaliação</a></div>
        </div>
      ...
      <footer id="contato"><div className="footer-main"><div className="footer-brand"><img src={asset("/assets/shelby-logo.png")} alt="Shelby Eletromecânica" /><p>Energia com segurança,<br />confiabilidade e excelência técnica.</p></div><div className="footer-contact"><span>FALE COM A SHELBY</span><a href="#diagnostico">Solicitar avaliação</a><a href="mailto:josuel@shelbyeletromecanica.com.br">josuel@shelbyeletromecanica.com.br</a></div><div className="footer-address"><span>BASE OPERACIONAL</span><p>Av. Aparecida, 465<br />Caieiras — SP</p><a href="#inicio">Voltar ao topo ↑</a></div></div><div className="footer-bottom"><span>SHELBY ELETROMECÂNICA</span><span>ENGENHARIA ELÉTRICA • ELETROMECÂNICA • MÉDIA TENSÃO</span></div></footer>
    </main>
  );
}
